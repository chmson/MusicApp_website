...
def GiveSongs(recents):
    ...
    return recommended_song_ids, sad_song_ids, party_song_ids, romance_song_ids
...
def music():
    ...
    return render_template('music1.html', recommended_song_ids=recommended_song_ids, sad_song_ids=sad_song_ids, party_song_ids=party_song_ids, romance_song_ids=romance_song_ids)
...
def playsong():
    if request.method == 'POST':
        ...
        print(recommended_song_ids[index_no])
        song = songs.query.filter_by(id=recommended_song_ids[index_no]).first()
